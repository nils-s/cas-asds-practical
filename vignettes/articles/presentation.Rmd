...
scaled_tracks |>
  add_column(cluster = factor(clusters_gaussian_mix$classification)) |>
  ggplot(aes(x = distance_km, y = speed_km_h, color = cluster)) +
  geom_point() +
  labs(x = "Distance (km)", y = "Speed (km/h)", color = "Cluster") +
...
scaled_tracks |>
  add_column(cluster = factor(clusters_db$cluster)) |>
  ggplot(aes(x = distance_km, y = speed_km_h, color = cluster)) +
  geom_point() +
  labs(x = "Distance (km)", y = "Speed (km/h)", color = "Cluster") +

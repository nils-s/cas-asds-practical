...
abstract: |
  ...
  in the data.
journal: "Institut für mathematische Statistik und Versicherungslehre (IMSV)"
date: "`r Sys.Date()`"
linenumbers: false
numbersections: true
...
classoption: 3p, authoryear # remove authoryear is not using `elsarticle-harv`
...
Figure \ref{fig:fig-tracks-per-year} shows the number of tracks for each year in the data set,
suggesting that a data block (or data blocks) containing records for 2022 and 2023 was lost.

```{r tab-tracks-per-year, tab.cap = "Number of tracks per year and month"}

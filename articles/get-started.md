...
This package contains a practical project for a university course on
data analytics. There’s some data, analyses that were performed on that
data, and some miscellaneous utilities and info snippets.

To get a first overview of the data, have a look at its documentation,
e.g.
...
![Tracks plotted on a map of cantons Berne and
Fribourg](get-started_files/figure-html/tracks-plot-1.png)

To learn more about the data, see
...
[`vignette("about")`](https://nils-s.github.io/cas-asds-practical/articles/about.md).
